...
pub struct Interpreter {
    pub funcs: HashMap<String, (Vec<String>, Vec<Stmt>, Option<Expr>)>,
    pub env: Env,
}
...
impl Interpreter {
    ...
    pub fn register_fn(
        ...
        self.funcs.insert(name, (params, body, expr_body));
    }
    ...
    fn call_ident(&mut self, name: &str, args: Vec<Expr>) -> Result<Value, String> {
        match name {
            ...
            other => {
                if let Some((params, body, expr_body)) = self.funcs.get(other).cloned() {
